...
function runSimulation() {
  try {
    ...
    // Опис генів (стабільні фенотипні назви)
    const geneDefs = [
      {
        trait: "Колір насіння",
        dom: "A",
...
function renderResults(
  ...
  output.appendChild(document.createElement("h3"))
    .textContent = "Генотипи нащадків";
